...
public partial class dashboard_sale : System.Web.UI.Page
{
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        try
        {
          ...
          dt = dobj.dash_sale_exp(txtstart.Text, txtend.Text, txtmob.Text);
            //ticket,name,alternate_no,alternate_no2,email,location,profession,location,source,model_interest,diesel_petrol,test_drive,current_vehicle_info,interest_in_exchange,date_of_entry,time_of_entry,executive_id,role
