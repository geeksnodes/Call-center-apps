<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Admin_service.aspx.cs" Inherits="service" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="Panel1" runat="server">
        <table style="margin-top: 10px;">
            <tr>
                <td>
                    <asp:Button ID="Button2sale" runat="server" CssClass="but" Text="Sale Enquiry" OnClick="Button2sale_Click" />
                </td>
                <td>
                    <asp:Button ID="Button1service" runat="server" CssClass="but" Text="Service Enquiry"
                        OnClick="Button1service_Click" />
                </td>
            </tr>
        </table>
            ...
            <table align="center" width="70%" cellpadding="5" cellspacing="5" style="margin-top: 20px;">
                ...
                <tr>
                    <td colspan="4" align="center">
                        <asp:Button ID="btnsubmit" runat="server" Text="Submit" CssClass="but" OnClick="btnsubmit_Click"
                            OnClientClick="return formvalidation()" />
                    </td>
                </tr>
                <tr>
                    <td colspan="4" align="center">
