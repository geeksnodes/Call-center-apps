...
public partial class dashboard_service : System.Web.UI.Page
{
    ...
    {
        GridView1.DataSource = dobj.dashboard_search_service(txtstart.Text, txtend.Text, txtmob.Text);
        GridView1.DataBind();
    }
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dt = dobj.dashboard_search_service_exp(txtstart.Text, txtend.Text, txtmob.Text);
            ...
            //ticket,name,alternate_no,alternate_no2,email,location,source,diesel_petrol,car_model,model_year,km_done,prefer_date_time,required_pickup,customer_loc,vehicle_reg_no,date_of_entry,time_of_entry,executive_id,role from sale_service
