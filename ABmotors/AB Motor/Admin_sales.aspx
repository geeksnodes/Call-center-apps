<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Admin_sales.aspx.cs" Inherits="sales" %>
...
<div width="70%" >-->
    ...
    <table style="margin-top:10px;">
        <tr>
            <td>
                <asp:Button ID="Buttonsale" runat="server" Text="Sale Enquiry" CssClass="but" OnClick="Buttonsale_Click1"></asp:Button>
            </td>
            <td>
                   <asp:Button ID="Buttonservice" runat="server" Text="Service Enquiry" CssClass="but" OnClick="Buttonservice_Click1"></asp:Button>
            </td>
        </tr>
    </table>
  ...
  <fieldset style="margin-left:3%;margin-right:3%;margin-bottom:2%;margin-top:2%" ><legend><b>Sale Enquiry</b></legend>
            ...
            <table align="center" width="70%" cellpadding="5" cellspacing="0" style="margin-top:20px;margin-left:20%;" >
                        <tr>
                            <td class="fldName">
                                Name :
                            </td>
