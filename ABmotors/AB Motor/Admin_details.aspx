<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Admin_details.aspx.cs" Inherits="Admin_details" %>
     ...
     <center>
        <div>
              ...
              <tr>
                  ...
                  <td>
                    <asp:TextBox ID="txtmob" runat="server" MaxLength="10" CssClass="boxshadow" placeholder="Mobile No." ></asp:TextBox>
                  </td>
                  <td>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <asp:GridView ID="GridView1" runat="server" CssClass="mGrid" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
                <Columns>
